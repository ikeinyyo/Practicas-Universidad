...
/**
 * It changes the intensity value for the minimum value in a neighborhood window with a 
 * specified size.<br />
 ...
 * </ul><br />
 */
public class Minimum extends Function2D {
	private static final long serialVersionUID = 2686998645864431044L;

	public Minimum() {
		super();
		name = "Minimum";
		description = "Changes the intensity value for minimum value in a neighbourhood window with a specified size. Applies to bitmap images.";
	...
	public JIPImage processImg(JIPImage img) throws JIPException {
		if (img instanceof JIPImgGeometric)	
			throw new JIPException("Function Minimum can not be applied to this image format.");
